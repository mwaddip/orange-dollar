...
export class MLDSAPrimitives {
    ...
    constructor(opts) {
        ...
        this.ETACoder = polyCoder(ETA === 2 ? 3 : 4, (i) => ETA - i, (i) => {
            if (!(-ETA <= i && i <= ETA))
        ...
        this.secretCoder = splitCoder('secretKey', 32, 32, TR_BYTES, vecCoder(this.ETACoder, L), vecCoder(this.ETACoder, K), vecCoder(this.T0Coder, K));
        this.sigCoder = splitCoder('signature', C_TILDE_BYTES, vecCoder(this.ZCoder, L), this.hintCoder);
    }
 ...
 */
export function createMLDSAPrimitives(opts) {
    return new MLDSAPrimitives(opts);
}
//# sourceMappingURL=ml-dsa-primitives.js.map